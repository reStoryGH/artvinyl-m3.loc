...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?= PATH ?>/assets/img/favicon.ico">
    <?= $this->getMeta() ?>
</head>
<body>
    ...
    <div class="header-top py-3">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col">
                    <a href="tel:+79001003030">
                        <span class="icon-phone">&#9743;</span> +7 900 100-30-30
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid p-0">
                    <a class="navbar-brand" href="<?= base_url() ?>"><?= \wfm\App::$app->getProperty('site_name') ?>
                        <img src="assets/img/LOGO_SUMMER_2022.svg" width="250" height="36">
                    </a>
